package com.example.MedAmineFouzai.Entites;
...
public class Vehicle {
    ...
    public Vehicle(String vehicleId, String vehicleType, String vehicleModel, Date vehicleCreationDate, Double vehiclePrice) {
